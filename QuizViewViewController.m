...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    fiftyFiftyNumber.text = fiftyAmount;
        ...
        if (lives==3) 
        {
            lifeOne.image = [UIImage imageNamed:@"soccerball"];
            lifeTwo.image = [UIImage imageNamed:@"soccerball"];
            lifeThree.image = [UIImage imageNamed:@"soccerball"];
        }
...
-(IBAction)changeSound:(id)sender
{
    ...
    {
        soundOptionImage.image = [UIImage imageNamed:@"soundOn"];
    ...
    {
        soundOptionImage.image = [UIImage imageNamed:@"soundOff"];
...
- (void)viewDidLoad
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
    {
        ...
        {
            bckgImage = [UIImage imageNamed:@"quizViewBckg1"];
        }else if(result.height == 568)
        {
            bckgImage = [UIImage imageNamed:@"quizViewBckg1-568h"];
        }else{
            bckgImage = [UIImage imageNamed:@"quizViewBckg1-568h"];
        }
    ...
    //AC Milan
    UIImage *milanCrest = [UIImage imageNamed:@"ACMilan"];
    ...
    //Arsenal
    UIImage *arsenalCrest = [UIImage imageNamed:@"Arsenal"];
    ...
    //Atletico Madrid
    UIImage *atletiCrest = [UIImage imageNamed:@"AtleticoMadrid"];
    ...
    //Barcelona
    UIImage *barcaCrest = [UIImage imageNamed:@"Barcelona"];
    ...
    //Bayern Munich
    UIImage *bayernCrest = [UIImage imageNamed:@"BayernMunich"];
    ...
    //Borussia Dortmund
    UIImage *dortCrest = [UIImage imageNamed:@"BorussiaDortmund"];
    ...
    //Chelsea
    UIImage *chelseaCrest = [UIImage imageNamed:@"Chelsea"];
    ...
    //Inter Milan
    UIImage *interCrest = [UIImage imageNamed:@"InterMilan"];
    ...
    //Juventus
    UIImage *juveCrest = [UIImage imageNamed:@"Juventus"];
    ...
    //Liverpool
    UIImage *liverCrest = [UIImage imageNamed:@"Liverpool"];
    ...
    //Lyon
    UIImage *lyonCrest = [UIImage imageNamed:@"Lyon"];
    ...
    //Manchester City
    UIImage *mancityCrest = [UIImage imageNamed:@"ManchesterCity"];
    ...
    //Manchester United
    UIImage *manutdCrest = [UIImage imageNamed:@"ManchesterUnited"];
    ...
    //PSG
    UIImage *psgCrest = [UIImage imageNamed:@"PSG"];
    ...
    //Real Madrid
    UIImage *madridCrest = [UIImage imageNamed:@"RealMadrid"];
    ...
    //Roma
    UIImage *romaCrest = [UIImage imageNamed:@"Roma"];
    ...
    //Schalke 04
    UIImage *schalkeCrest = [UIImage imageNamed:@"Schalke04"];
    ...
    //Tottenham
    UIImage *tottenCrest = [UIImage imageNamed:@"Tottenham"];
    ...
    //Ajax
    UIImage *ajaxCrest = [UIImage imageNamed:@"Ajax"];
    ...
    //Athletic Bilbao
    UIImage *bilbaoCrest = [UIImage imageNamed:@"AthleticBilbao"];
    ...
    //Benfica
    UIImage *benficaCrest = [UIImage imageNamed:@"Benfica"];
    ...
    //Boca Juniors
    UIImage *bocaCrest = [UIImage imageNamed:@"BocaJuniors"];
    ...
    //Celtic
    UIImage *celticCrest = [UIImage imageNamed:@"Celtic"];
    ...
    //Everton
    UIImage *evertonCrest = [UIImage imageNamed:@"Everton"];
    ...
    //Fulham
    UIImage *fulhamCrest = [UIImage imageNamed:@"Fulham"];
    ...
    //LA Galaxy
    UIImage *galaxyCrest = [UIImage imageNamed:@"LAGalaxy"];
    ...
    //Marseille
    UIImage *marseilleCrest = [UIImage imageNamed:@"Marseille"];
    ...
    //Napoli
    UIImage *napoliCrest = [UIImage imageNamed:@"Napoli"];
    ...
    //Newcastle
    UIImage *castleCrest = [UIImage imageNamed:@"Newcastle"];
    ...
    //Porto
    UIImage *portoCrest = [UIImage imageNamed:@"Porto"];
    ...
    //River Plate
    UIImage *riverCrest = [UIImage imageNamed:@"RiverPlate"];
    ...
    //Santos
    UIImage *santosCrest = [UIImage imageNamed:@"Santos"];
    ...
    //Sevilla
    UIImage *sevillaCrest = [UIImage imageNamed:@"Sevilla"];
    ...
    //Stuttgart
    UIImage *stuttCrest = [UIImage imageNamed:@"Stuttgart"];
    ...
    //Valencia
    UIImage *valenCrest = [UIImage imageNamed:@"Valencia"];
    ...
    //West Ham
    UIImage *hamCrest = [UIImage imageNamed:@"WestHam"];
    ...
    //Aston Villa
    UIImage *villaCrest = [UIImage imageNamed:@"AstonVilla"];
    ...
    //AZ Alkmaar
    UIImage *azCrest = [UIImage imageNamed:@"AZAlkmaar"];
    NSString *azOne = @"Ajax";
    ...
    //BayerLeverkusen
    UIImage *leverCrest = [UIImage imageNamed:@"BayerLeverkusen"];
    ...
    //Corinthians
    UIImage *corinCrest = [UIImage imageNamed:@"Corinthians"];
    ...
    //Espanyol
    UIImage *espanyolCrest = [UIImage imageNamed:@"Espanyol"];
    ...
    //Fiorentina
    UIImage *fioreCrest = [UIImage imageNamed:@"Fiorentina"];
    ...
    //Hamburg
    UIImage *hamburgCrest = [UIImage imageNamed:@"Hamburg"];
    ...
    //Internacional
    UIImage *interpaCrest = [UIImage imageNamed:@"Internacional"];
    ...
    //Malaga
    UIImage *malagaCrest = [UIImage imageNamed:@"Malaga"];
    ...
    //NY Bulls
    UIImage *nyCrest = [UIImage imageNamed:@"NYBulls"];
    ...
    //Olympiakos
    UIImage *olympCrest = [UIImage imageNamed:@"Olympiakos"];
    ...
    //PSV Eindhoven
    UIImage *psvCrest = [UIImage imageNamed:@"PSV"];
    ...
    //Sao Paulo
    UIImage *saoCrest = [UIImage imageNamed:@"SaoPaulo"];
    ...
    //Stoke City
    UIImage *stokeCrest = [UIImage imageNamed:@"StokeCity"];
    ...
    //Sunderland
    UIImage *sunderCrest = [UIImage imageNamed:@"Sunderland"];
    ...
    UIImage *wbaCrest = [UIImage imageNamed:@"WBA"];
    ...
    //Werder Bremen
    UIImage *werderCrest = [UIImage imageNamed:@"WerderBremen"];
    ...
    //Wigan Athletic
    UIImage *wiganCrest = [UIImage imageNamed:@"Wigan"];
    ...
    //Real Betis
    UIImage *betisCrest = [UIImage imageNamed:@"Betis"];
    ...
    //CSKA Moscow
    UIImage *cskaCrest = [UIImage imageNamed:@"CSKAMoscow"];
    ...
    //Feyenoord
    UIImage *feyerCrest = [UIImage imageNamed:@"Feyenoord"];
    ...
    //Flamengo
    UIImage *flamCrest = [UIImage imageNamed:@"Flamengo"];
    ...
    //Galatasaray
    UIImage *galatCrest = [UIImage imageNamed:@"Galatasaray"];
    ...
    //Getafe
    UIImage *getafeCrest = [UIImage imageNamed:@"Getafe"];
    ...
    //Levante
    UIImage *levanCrest = [UIImage imageNamed:@"Levante"];
    ...
    //Mallorca
    UIImage *malloCrest = [UIImage imageNamed:@"Mallorca"];
    ...
    //Norwich City
    UIImage *norwCrest = [UIImage imageNamed:@"Norwich"];
    ...
    //QPR
    UIImage *qprCrest = [UIImage imageNamed:@"QPR"];
    ...
    //Real Sociedad
    UIImage *socieCrest = [UIImage imageNamed:@"RealSociedad"];
    ...
    //Siena
    UIImage *sienaCrest = [UIImage imageNamed:@"siena"];
    ...
    //Sporting Lisbon
    UIImage *lisbonCrest = [UIImage imageNamed:@"Sporting"];
    ...
    //Swansea City
    UIImage *swanCrest = [UIImage imageNamed:@"Swansea"];
    ...
    //Twente
    UIImage *twentCrest = [UIImage imageNamed:@"Twente"];
    ...
    //Udinese
    UIImage *udineCrest = [UIImage imageNamed:@"Udinese"];
    ...
    //Velez Sarfield
    UIImage *velezCrest = [UIImage imageNamed:@"VelezSarfield"];
    ...
    //Villarreal
    UIImage *villarCrest = [UIImage imageNamed:@"Villarreal"];
    ...
    //Atalanta
    UIImage *atalaCrest = [UIImage imageNamed:@"Atalanta"];
    ...
    //Celta de Vigo
    UIImage *vigoCrest = [UIImage imageNamed:@"CeltaDeVigo"];
    ...
    //Deportivo La Coruna
    UIImage *deporCrest = [UIImage imageNamed:@"DepLaCoruna"];
    ...
    UIImage *plataCrest = [UIImage imageNamed:@"EstudiantesLaPlata"];
    ...
    //Fenerbahce
    UIImage *fenerCrest = [UIImage imageNamed:@"Fenerbahce"];
    ...
    //Fluminese
    UIImage *flumiCrest = [UIImage imageNamed:@"Fluminese"];
    ...
    //Frankfurt
    UIImage *frankCrest = [UIImage imageNamed:@"Frankfurt"];
    ...
    //Hannover 96
    UIImage *hannoCrest = [UIImage imageNamed:@"Hannover96"];
    ...
    //Houston Dynamo
    UIImage *houCrest = [UIImage imageNamed:@"HoustonDynamo"];
    ...
    //Lazio
    UIImage *lazCrest = [UIImage imageNamed:@"Lazio"];
    ...
    //Osasuna
    UIImage *osaCrest = [UIImage imageNamed:@"Osasuna"];
    ...
    //Parma
    UIImage *parmaCrest = [UIImage imageNamed:@"Parma"];
    ...
    //Reading
    UIImage *readCrest = [UIImage imageNamed:@"Reading"];
    ...
    //San Lorenzo
    UIImage *lorenCrest = [UIImage imageNamed:@"SanLorenzo"];
    ...
    //Southampton
    UIImage *southCrest = [UIImage imageNamed:@"Southampton"];
    ...
    //Valladolid
    UIImage *vallaCrest = [UIImage imageNamed:@"Valladolid"];
    ...
    //Zaragoza
    UIImage *zaraCrest = [UIImage imageNamed:@"Zaragoza"];
    ...
    //Zenit
    UIImage *zenitCrest = [UIImage imageNamed:@"Zenit"];
    ...
    //AEK Athens
    UIImage *aekCrest = [UIImage imageNamed:@"AEKAthens"];
    ...
    //Al Ahly
    UIImage *ahlyCrest = [UIImage imageNamed:@"AlAhly"];
    ...
    //Anderlecht
    UIImage *anderCrest = [UIImage imageNamed:@"Anderlecht"];
    ...
    //Atletico Mineiro
    UIImage *mineiCrest = [UIImage imageNamed:@"AtleticoMineiro"];
    ...
    //Blackburn
    UIImage *blackCrest = [UIImage imageNamed:@"Blackburn"];
    ...
    //Bordeaux
    UIImage *bordCrest = [UIImage imageNamed:@"Bordeaux"];
    ...
    //Catania
    UIImage *cataCrest = [UIImage imageNamed:@"Catania"];
    ...
    //Chievo
    UIImage *chievoCrest = [UIImage imageNamed:@"Chievo"];
    ...
    //Independiente
    UIImage *indeCrest = [UIImage imageNamed:@"Independiente"];
    ...
    //LOSC Lille
    UIImage *lilleCrest = [UIImage imageNamed:@"LOSCLille"];
    ...
    //Monaco
    UIImage *monaCrest = [UIImage imageNamed:@"Monaco"];
    ...
    //Montpelllier
    UIImage *montpCrest = [UIImage imageNamed:@"Montpellier"];
    ...
    //Palermo
    UIImage *palerCrest = [UIImage imageNamed:@"Palermo"];
    ...
    //Panathinaikos
    UIImage *panaCrest = [UIImage imageNamed:@"Panathinaikos"];
    ...
    //Rangers
    UIImage *rangCrest = [UIImage imageNamed:@"Rangers"];
    ...
    //Shakhtar Donetsk
    UIImage *shakCrest = [UIImage imageNamed:@"Shakhtar"];
    ...
    //Torino
    UIImage *torCrest = [UIImage imageNamed:@"Torino"];
    ...
    //Wolverhampton
    UIImage *wolveCrest = [UIImage imageNamed:@"Wolverhampton"];
    ...
    //Anzhi Makhachkala
    UIImage *anzCrest = [UIImage imageNamed:@"AnzhiMakhachkala"];
    ...
    //Auxerre
    UIImage *auxCrest = [UIImage imageNamed:@"Auxerre"];
    ...
    //Colo Colo
    UIImage *coloCrest = [UIImage imageNamed:@"ColoColo"];
    ...
    //Cruzeiro
    UIImage *cruCrest = [UIImage imageNamed:@"Cruzeiro"];
    ...
    //DynamoKiev
    UIImage *kievCrest = [UIImage imageNamed:@"DynamoKiev"];
    ...
    //FC Basel
    UIImage *baseCrest = [UIImage imageNamed:@"FCBasel"];
    ...
    //Genoa
    UIImage *genoCrest = [UIImage imageNamed:@"Genoa"];
    ...
    //Lorient
    UIImage *lorCrest = [UIImage imageNamed:@"Lorient"];
    ...
    //Mainz 05
    UIImage *mainzCrest = [UIImage imageNamed:@"Mainz05"];
    ...
    //Mochengladbach
    UIImage *mochCrest = [UIImage imageNamed:@"Mochengladbach"];
    ...
    //Monterrey
    UIImage *monCrest = [UIImage imageNamed:@"Monterrey"];
    ...
    //Nacional
    UIImage *naciCrest = [UIImage imageNamed:@"Nacional"];
    ...
    //Nuremberg
    UIImage *nurCrest = [UIImage imageNamed:@"Nuremberg"];
    ...
    //Rubin Kazan
    UIImage *rubinCrest = [UIImage imageNamed:@"RubinKazan"];
    ...
    //Sampdoria
    UIImage *sampCrest = [UIImage imageNamed:@"Sampdoria"];
    ...
    //Seattle Sounders
    UIImage *seatCrest = [UIImage imageNamed:@"SeattleSounders"];
    ...
    //Sparta Prague
    UIImage *spartCrest = [UIImage imageNamed:@"SpartaPrague"];
    ...
    //Wolfsburg
    UIImage *wolfCrest = [UIImage imageNamed:@"Wolfsburg"];
    ...
    //America 
    UIImage *ameriCrest = [UIImage imageNamed:@"America"];
    ...
    //Birmingham City
    UIImage *birmCrest = [UIImage imageNamed:@"BirminghamCity"];
    ...
    //Cagliari
    UIImage *cagliCrest = [UIImage imageNamed:@"Cagliari"];
    ...
    //Chicago Fire
    UIImage *chiCrest = [UIImage imageNamed:@"ChicagoFire"];
    ...
    //Chivas
    UIImage *chivCrest = [UIImage imageNamed:@"Chivas"];
    ...
    //Deportivo Cali
    UIImage *caliCrest = [UIImage imageNamed:@"DeportivoCali"];
    ...
    //Dinamo Zagreb
    UIImage *zagCrest = [UIImage imageNamed:@"DinamoZagreb"];
    ...
    //FC Dallas
    UIImage *dalCrest = [UIImage imageNamed:@"FCDallas"];
    ...
    //Kaiserlautern
    UIImage *kaisCrest = [UIImage imageNamed:@"Kaiserlautern"];
    ...
    //Lanus
    UIImage *lanuCrest = [UIImage imageNamed:@"Lanus"];
    ...
    //Leeds United
    UIImage *leedCrest = [UIImage imageNamed:@"leeds"];
    ...
    //Penarol
    UIImage *penaCrest = [UIImage imageNamed:@"Penarol"];
    ...
    //Rayo Vallecano
    UIImage *rayoCrest = [UIImage imageNamed:@"RayoVallecano"];
    ...
    //Saint Etienne
    UIImage *etienCrest = [UIImage imageNamed:@"SaintEtienne"];
    ...
    //Stade Rennais
    UIImage *rennCrest = [UIImage imageNamed:@"StadeRennais"];
    ...
    //Steaua Bucharest
    UIImage *steauaCrest = [UIImage imageNamed:@"SteauaBucharest"];
    ...
    //Tigre
    UIImage *tigCrest = [UIImage imageNamed:@"Tigre"];
    ...
    //Almeria
    UIImage *almCrest = [UIImage imageNamed:@"Almeria"];
    ...
    //APOEL
    UIImage *apoCrest = [UIImage imageNamed:@"APOEL"];
    ...
    //Botafogo
    UIImage *botaCrest = [UIImage imageNamed:@"Botafogo"];
    ...
    //Charlton Athletic
    UIImage *charCrest = [UIImage imageNamed:@"CharltonAthletic"];
    ...
    //Cruz Azul
    UIImage *cruzaCrest = [UIImage imageNamed:@"CruzAzul"];
    ...
    //Dusseldorf
    UIImage *dussCrest = [UIImage imageNamed:@"Dusseldorf"];
    ...
    //Granada
    UIImage *granCrest = [UIImage imageNamed:@"Granada"];
    ...
    //Gremio
    UIImage *gremCrest = [UIImage imageNamed:@"Gremio"];
    ...
    //Hoffenheim
    UIImage *hoffCrest = [UIImage imageNamed:@"Hoffenheim"];
    ...
    UIImage *indepCrest = [UIImage imageNamed:@"IndependienteMedellin"];
    ...
    //Middlesbrough
    UIImage *midCrest = [UIImage imageNamed:@"Middlesbrough"];
    ...
    //Newells
    UIImage *neweCrest = [UIImage imageNamed:@"Newells"];
    ...
    //OnceCaldas
    UIImage *onceCrest = [UIImage imageNamed:@"OnceCaldas"];
    ...
    //PohangSteelers
    UIImage *pohCrest = [UIImage imageNamed:@"PohangSteelers"];
    ...
    //SportingBraga
    UIImage *bragCrest = [UIImage imageNamed:@"SportingBraga"];
    ...
    //SportingGijon
    UIImage *gijCrest = [UIImage imageNamed:@"SportingGijon"];
    ...
    //TigresUANL
    UIImage *uanlCrest = [UIImage imageNamed:@"TigresUANL"];
    ...
    //Toulouse
    UIImage *touCrest = [UIImage imageNamed:@"Toulouse"];
    ...
    //Ajaccio
    UIImage *ajaCrest = [UIImage imageNamed:@"Ajaccio"];
    ...
    //Alianza Lima
    UIImage *limaCrest = [UIImage imageNamed:@"AlianzaLima"];
    ...
    //BATE Borisov
    UIImage *bateCrest = [UIImage imageNamed:@"BATEBorisov"];
    ...
    //Brescia
    UIImage *breCrest = [UIImage imageNamed:@"Brescia"];
    ...
    //Cardiff City
    UIImage *cardCrest = [UIImage imageNamed:@"CardiffCity"];
    ...
    //Cerro Porteno
    UIImage *cerroCrest = [UIImage imageNamed:@"CerroPorteno"];
    ...
    //Cesena
    UIImage *cesCrest = [UIImage imageNamed:@"Cesena"];
    ...
    //Club Libertad
    UIImage *libCrest = [UIImage imageNamed:@"ClubLibertad"];
    ...
    //Cologne
    UIImage *colCrest = [UIImage imageNamed:@"Cologne"];
    ...
    //Crystal Palace
    UIImage *crysCrest = [UIImage imageNamed:@"CrystalPalace"];
    ...
    //Groningen
    UIImage *gronCrest = [UIImage imageNamed:@"Groningen"];
    ...
    //Hertha Berlin
    UIImage *herCrest = [UIImage imageNamed:@"HerthaBerlin"];
    ...
    //Hull City
    UIImage *hullCrest = [UIImage imageNamed:@"HullCity"];
    ...
    //Palmeiras
    UIImage *palmCrest = [UIImage imageNamed:@"Palmeiras"];
    ...
    //Racing Santander
    UIImage *racCrest = [UIImage imageNamed:@"RacingSantander"];
    ...
    //Santos Laguna
    UIImage *santCrest = [UIImage imageNamed:@"SantosLaguna"];
    ...
    UIImage *ucCrest = [UIImage imageNamed:@"UCatolica"];
    ...
    //ValenciennesFC
    UIImage *valCrest = [UIImage imageNamed:@"ValenciennesFC"];
    ...
    //Augsburg
    UIImage *augCrest = [UIImage imageNamed:@"Augsburg"];
    ...
    //Blackpool
    UIImage *bpoolCrest = [UIImage imageNamed:@"Blackpool"];
    ...
    //Bologna
    UIImage *bolCrest = [UIImage imageNamed:@"Bologna"];
    ...
    //Columbus Crew
    UIImage *crewCrest = [UIImage imageNamed:@"ColumbusCrew"];
    ...
    //DCUnited
    UIImage *dcCrest = [UIImage imageNamed:@"DCUnited"];
    ...
    //Heracles
    UIImage *heraCrest = [UIImage imageNamed:@"Heracles"];
    ...
    //Livorno
    UIImage *livoCrest = [UIImage imageNamed:@"Livorno"];
    ...
    //Millonarios
    UIImage *millCrest = [UIImage imageNamed:@"Millonarios"];
    ...
    //Notts Forest
    UIImage *nottsCrest = [UIImage imageNamed:@"NottsForest"];
    ...
    //OGC Nice
    UIImage *niceCrest = [UIImage imageNamed:@"OGCNice"];
    ...
    //Pachuca
    UIImage *pachuCrest = [UIImage imageNamed:@"Pachuca"];
    ...
    //Pumas
    UIImage *pumasCrest = [UIImage imageNamed:@"Pumas"];
    ...
    //Quilmes
    UIImage *quilmCrest = [UIImage imageNamed:@"Quilmes"];
    ...
    //Racing Avellaneda
    UIImage *raciCrest = [UIImage imageNamed:@"RacingAvellaneda"];
    ...
    //Reggina
    UIImage *reggCrest = [UIImage imageNamed:@"Reggina"];
    ...
    //SC Bastia
    UIImage *bastiaCrest = [UIImage imageNamed:@"SCBastia"];
    ...
    //U de Chile
    UIImage *uchileCrest = [UIImage imageNamed:@"UdeChile"];
    ...
    //Vasco Da Gama
    UIImage *vascoCrest = [UIImage imageNamed:@"VascoDaGama"];
    ...
    //ADO Den Haag
    UIImage *haagCrest = [UIImage imageNamed:@"ADODenHaag"];
    ...
    //ASNancy
    UIImage *nancyCrest = [UIImage imageNamed:@"ASNancy"];
    ...
    //BSC Young Boys
    UIImage *ybCrest = [UIImage imageNamed:@"BSCYoungBoys"];
    ...
    //Copenhagen
    UIImage *copCrest = [UIImage imageNamed:@"Copenhagen"];
    ...
    //Deportivo Quito
    UIImage *quitoCrest = [UIImage imageNamed:@"DeportivoQuito"];
    ...
    //ESTAC Troyes
    UIImage *troyCrest = [UIImage imageNamed:@"ESTACTroyes"];
    ...
    //Estoril Praia
    UIImage *praiaCrest = [UIImage imageNamed:@"EstorilPraia"];
    ...
    //Furth
    UIImage *furthCrest = [UIImage imageNamed:@"Furth"];
    ...
    //Godoy Cruz
    UIImage *godoyCrest = [UIImage imageNamed:@"GodoyCruz"];
    ...
    //Kashiwa Reysol
    UIImage *kashiCrest = [UIImage imageNamed:@"KashiwaReysol"];
    ...
    //Leicester City
    UIImage *leicCrest = [UIImage imageNamed:@"LeicesterCity"];
    ...
    //Recreativo Huelva
    UIImage *huelvaCrest = [UIImage imageNamed:@"RecreativoHuelva"];
    ...
    //Stade De Reims
    UIImage *reimsCrest = [UIImage imageNamed:@"StadeDeReims"];
    ...
    //TP Mazembe
    UIImage *mazCrest = [UIImage imageNamed:@"TPMazembe"];
    ...
    //Utrecht
    UIImage *utrCrest = [UIImage imageNamed:@"Utrecht"];
    ...
    //Vitesse
    UIImage *vitCrest = [UIImage imageNamed:@"Vitesse"];
    ...
    //Willem II
    UIImage *willCrest = [UIImage imageNamed:@"WillemII"];
    ...
    //Xerez
    UIImage *xerezCrest = [UIImage imageNamed:@"Xerez"];
    ...
    //Alajuelense
    UIImage *alaCrest = [UIImage imageNamed:@"Alajuelense"];
    ...
    //Al Ittihad
    UIImage *ittiCrest = [UIImage imageNamed:@"AlIttihad"];
    ...
    //Bristol City
    UIImage *bristolCrest = [UIImage imageNamed:@"BristolCity"];
    ...
    //CFR Cluj
    UIImage *clujCrest = [UIImage imageNamed:@"CFRCluj"];
    ...
    //Club Brugge
    UIImage *bruggeCrest = [UIImage imageNamed:@"ClubBrugge"];
    ...
    //Club Olimpia
    UIImage *olimCrest = [UIImage imageNamed:@"ClubOlimpia"];
    ...
    //Evian TG FC
    UIImage *evianCrest = [UIImage imageNamed:@"EvianTGFC"];
    ...
    //FC Metalist
    UIImage *metaCrest = [UIImage imageNamed:@"FCMetalist"];
    ...
    //Genk
    UIImage *genkCrest = [UIImage imageNamed:@"Genk"];
    ...
    //Ipswich Town
    UIImage *ipsCrest = [UIImage imageNamed:@"IpswichTown"];
    ...
    //Maccabi Tel Aviv
    UIImage *maccCrest = [UIImage imageNamed:@"Maccabi"];
    ...
    //NE Revolution
    UIImage *neCrest = [UIImage imageNamed:@"NERevolution"];
    ...
    //Real Salt Lake
    UIImage *rslCrest = [UIImage imageNamed:@"RealSaltLake"];
    ...
    //Rosenborg
    UIImage *rosCrest = [UIImage imageNamed:@"Rosenborg"];
    ...
    //Stade Brestois
    UIImage *brestCrest = [UIImage imageNamed:@"StadeBrestois"];
    ...
    //Tijuana
    UIImage *tijCrest = [UIImage imageNamed:@"Tijuana"];
    ...
    //Ulsan Hyundai
    UIImage *hyunCrest = [UIImage imageNamed:@"UlsanHyundai"];
    ...
    //Viktoria Plzen
    UIImage *vikCrest = [UIImage imageNamed:@"ViktoriaPlzen"];
